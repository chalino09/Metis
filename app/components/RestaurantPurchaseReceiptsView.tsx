...
import { DataPagination, DataState, DataToolbar, InteractiveTableRow, Table } from "@/app/components/ui/data";
...
type Ingredient = { id:string;internal_sku:string;name:string;purchase_unit:string;base_unit:string;base_units_per_purchase_unit:number;lot_controlled:boolean;current_cost:number|null;current_purchase_unit_cost?:number|null;currency_code:string|null };
...
const purchasePrice=(item:Ingredient)=>item.current_purchase_unit_cost??(item.current_cost==null?null:item.current_cost*item.base_units_per_purchase_unit);
