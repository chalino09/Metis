...
type Detail = { id: string; folio: string; status: Status; currency_code: string; valid_until: string | null; subtotal_amount: number; tax_amount: number; total_amount: number; customer: Customer; location: Location; lines: Line[]; follow_ups: FollowUp[]; order: { id: string; folio: string; status: "open" | "completed" } | null };
