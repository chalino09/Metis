...
export function SalesQuotesView({ companyId, permissions }: { companyId: string; permissions: string[] }) {
  ...
  return <div className="content-frame sales-quotes">
    ...
    <Tabs className="sales-quotes__tabs" ariaLabel="Secciones de cotizaciones" value={section} onValueChange={(value) => setSection(value as "quotes" | "prepare")} items={[{ value: "quotes", label: "Cotizaciones" }, { value: "prepare", label: "Por preparar" }]} />
    {section === "quotes" ? <>
