...
// ReUI Stepper (MIT), adapted to Satrapy's scoped stylesheet.
// Source: https://v1.reui.io/r/stepper.json
...
function StepperTrigger({
  ...
  const handleKeyDown = (e: React.KeyboardEvent<HTMLButtonElement>) => {
    const myIdx = triggerNodes.findIndex((node) => node === btnRef.current);
    switch (e.key) {
      case "ArrowRight":
      case "ArrowDown":
        e.preventDefault();
