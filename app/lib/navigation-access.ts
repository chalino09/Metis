...
export const ROLE_PREVIEW_PERMISSIONS: Record<AppRoleCode, string[]> = {
  ...
  punto_venta: ["view_products", "view_inventory", "view_prices", "use_pos", "view_sales", "sell_cash", "manage_customers", "view_customer_credit", "apply_discount", "open_cash_session", "close_own_cash_session", "record_cash_movement", "view_cash_reports", "record_receivable_payment"],
};
