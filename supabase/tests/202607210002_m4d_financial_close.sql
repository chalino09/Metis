...
declare
  ...
  customer uuid:='4d000000-0000-4000-8000-000000000050';receivable uuid:='4d000000-0000-4000-8000-000000000051';method uuid:='4d000000-0000-4000-8000-000000000052';rp1 uuid:='4d000000-0000-4000-8000-000000000053';rp2 uuid:='4d000000-0000-4000-8000-000000000054';rp3 uuid:='4d000000-0000-4000-8000-000000000055';
...
begin
  ...
  insert into public.receivable_payments(id,company_id,customer_id,payment_method_id,payment_method_code,settlement_kind,amount,client_request_id,received_by,received_at) values
    (rp1,c,customer,method,'TR','external',40,gen_random_uuid(),u,'2026-07-10'),(rp2,c,customer,method,'TR','external',10,gen_random_uuid(),u,'2026-07-20'),(rp3,c,customer,method,'TR','external',20,gen_random_uuid(),u,'2026-08-02');
