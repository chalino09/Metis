-- Satrapy · Corrección de despliegues que conservaban la confirmación anterior
-- de pagos a proveedor. No altera pagos históricos: sólo rige confirmaciones
-- futuras y conserva la liquidación completa del descuento de pronto pago.
